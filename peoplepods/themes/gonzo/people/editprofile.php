...
/**********************************************/
?>
<div class="column_5 right">
      <div id="my_location" class="profile_control third_box right">
    <h2>My Location</h2>
    <div id="map"></div>
    <?
...
<script type="text/javascript">
    $(document).ready(function(){
       ...
       createMap('map',200, 290,lat, lng, function(){
       createHomeMarker(function(){
        ...
        google.maps.event.addListener(homeMarker, 'dragend', function(){
            ...
            var pos= this.position;
                $.getJSON(siteRoot+"/server/updateloc&lat="+pos.lat()+"&lng="+pos.lng(), function(json){
                complain(json.msg);
            });
        });
       });
